    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center container">
            ...
            <div className="md:pe-5 flex flex-col justify-center">
                <h2 className="text-3xl font-bold text-center mb-8 text-primary">Mengenal Kami</h2>
                <p className="text-lg text-foreground font-semibold text-center mb-8">
                    Rehat Springbed adalah Lorem ipsum dolor sit amet consectetur adipisicing elit. Blanditiis esse ratione, ad dolor possimus maiores? Architecto eligendi provident tempore! Iste commodi sint quis sequi quas!
                </p>
            </div>
        </div>
    )
