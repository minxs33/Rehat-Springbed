        ...
        <div className="lg:col-span-6 flex flex-col gap-6 xl:gap-4 justify-center text-wrap lg:text-left">
          ...
          <div className="flex justify-center gap-4 lg:justify-start">
            <SocialButton
              ...
              className="whatsapp-button px-6 py-2 lg:px-8 lg:py-4 bg-[#26997A] text-white hover:bg-[#64D8B9] text-base sm:text-sm md:text-md lg:text-lg text-nowrap rounded-full"
              icon={
            ...
            <div id="instagram-button" className="p-[2px] rounded-full bg-gradient-to-r from-[#f58529] via-[#dd2a7b] to-[#515bd4] inline-block drop-shadow-lg transition duration-300 ease-in-out">
              <SocialButton 
                ...
                className=" bg-background-2 p-5 text-nowrap rounded-full"
                icon={
                  <svg
                    className="w-6 h-6"
                    width="180"
